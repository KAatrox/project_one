...
<body>
	...
	<div class="login-page">
		<div class="container"> 
			<h3 class="w3ls-title w3ls-title1">Administrators</h3>  
			<div class="login-body">
				<form action="/ComperterShop/shop/doBacklogin" method="post">
					<input type="text" class="user" id="username" name="username" placeholder="管理员帐号" required="" value="${cookie.username.value}" onblur="cklname(this)">
