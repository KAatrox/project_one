					...
					<div class="col-md-6 single-top-left">	
						<div class="flexslider">
							...
							<c:set var="photo" value="${fn:split(good.comphoto, ',')}"/>
								<li data-thumb="images/${param.images1}.jpg">
									<div class="thumb-image detail_images"> <img src="images/${param.images1}.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
								</li>
								<li data-thumb="images/${param.images2}.jpg">
									 <div class="thumb-image"> <img src="images/${param.images2}.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
								</li>
								<li data-thumb="images/${param.images3}.jpg">
								   <div class="thumb-image"> <img src="images/${param.images3}.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
								</li> 
							</ul>
						</div>
					</div>
					<div class="col-md-6 single-top-right">
						<h3 class="item_name">${param.comname}</h3>
						<p>处理时间：项目将在2-3个工作日内发货。 </p>
						...
						<p class="single-price-text">${param.descible} </p>
						<form action="#" method="post">
							<input type="hidden" name="cmd" value="_cart" />
							<input type="hidden" name="add" value="1" /> 
							<input type="hidden" name="w3ls_item" value="Snow Blower" /> 
							<input type="hidden" name="amount" value="540.00" /> 
							<a href="/addcarts?&name=${param.comname} &id=${param.comid}&price=${param.price}&images1=${param.photo[0]}&images2=${param.photo[1]}&images3=${param.photo[2]}" class="w3ls-cart" onclick="javascript:return addcart();"><i class="fa fa-cart-plus" aria-hidden="true"></i> 添加到购物车</a>
						</form>
						<button class="w3ls-cart w3ls-cart-like"><i class="fa fa-heart-o" aria-hidden="true"></i> 添加到收藏夹</button>
					</div>
				   <div class="clearfix"> </div>  
				</div>
