				...
				<ul>
					<li class="dropdown head-dpdn">
						...
						<ul class="dropdown-menu">
							<li><a href="login">登录<%=s.getAttribute("username")%></a></li> 
					...
					<li class="dropdown head-dpdn">
						<a href="contact" class="dropdown-toggle"><i class="fa fa-map-marker" aria-hidden="true"></i> 存储查找器</a>
					</li> 
					<li class="dropdown head-dpdn">
		...
		<div class="header-two"><!-- header-two -->
			<div class="container">
				...
				<div class="header-search">
					<form action="/ComperterShop/shop/searchproducts" method="post">
				...
				<div class="header-cart"> 
					<div class="my-account">
						<a href="contact"><i class="fa fa-map-marker" aria-hidden="true"></i> 联系我们</a>						
					</div>
					<div class="cart"> 
