		...
		<div class="container">
				...
				<div class="products-row">
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="single.html"><img src="images/a5.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.html">Tyre</a></h5> 
								<h6><del>$45</del> $40</h6> 
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.html"><img src="images/a6.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.html">Helmet </a></h5> 
								<h6><del>$20</del> $17</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/> 
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="single.html"><img src="images/a2.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.html">Car Battery</a></h5> 
								<h6><del>$26</del> $25</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							<div class="new-tag"><h6>OFF</h6></div>
							<a href="single.html"><img src="images/a3.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.html">Seating Pad</a></h5> 
								<h6><del>$32</del> $30</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/> 
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							<div class="new-tag"><h6>OFF</h6></div>
							<a href="single.html"><img src="images/a4.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.html">Coolant </a></h5> 
								<h6><del>$15</del> $13</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/> 
			...
			<div class="col-md-3 rsidebar">
				...
				<div class="related-row">
					...
					<ul>
						<li><a href="products.html">Wheel Covers</a></li>
						<li><a href="products.html">Cargo Management</a></li>
						<li><a href="products.html">Polish & Waxes</a></li>
						<li><a href="products.html">GPS Navigation</a></li>
						<li><a href="products.html">Cleaning Tools</a></li>
						<li><a href="products.html">Detailing Kits</a></li>
						<li><a href="products.html">Car Washes</a></li>
						<li><a href="products.html">Auto Repair Tools</a></li>
						<li><a href="products.html">Helmets</a></li>
						<li><a href="products.html">Sensors</a></li>
					</ul>
				</div>
				<div class="related-row">
