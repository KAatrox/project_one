				...
				<div class="products-row">
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="single.html"><img src="images/m1.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.html">Teens Book</a></h5> 
								<h6><del>$10</del> $9</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
									<input type="hidden" name="w3ls_item" value="Teens Book"/> 
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.html"><img src="images/m2.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.html">Music CD</a></h5> 
								<h6><del>$5</del> $4</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/> 
									<input type="hidden" name="w3ls_item" value="Music CD"/> 
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="single.html"><img src="images/m3.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.html">Movie DVD</a></h5> 
								<h6><del>$8</del>$6</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
									<input type="hidden" name="w3ls_item" value="Movie DVD"/> 
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.html"><img src="images/m4.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.html">Story Book</a></h5> 
								<h6><del>$10</del> $8</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/> 
									<input type="hidden" name="w3ls_item" value="Story Book"/> 
			...
			<div class="col-md-3 rsidebar">
				<div class="rsidebar-top">
					...
					<div class="sidebar-row">
						<h4>Books & Music</h4>
						<ul class="faq">
							<li class="item1"><a href="#">Books<span class="glyphicon glyphicon-menu-down"></span></a>
								<ul>
									<li class="subitem1"><a href="#">Exam books</a></li>										
									<li class="subitem1"><a href="#">Academic Text</a></li>										
									<li class="subitem1"><a href="#">Romance Books</a></li>										
									<li class="subitem1"><a href="#">Journals</a></li>										
								</ul>
							</li>
							<li class="item2"><a href="#">Music<span class="glyphicon glyphicon-menu-down"></span></a>
								<ul>
							...
							<li class="item3"><a href="#">Movies<span class="glyphicon glyphicon-menu-down"></span></a>
								<ul>
				...
				<div class="related-row">
					...
					<ul>
						<li><a href="products.html">Civil Services</a></li>
						<li><a href="products.html">Academic Text</a></li>
						<li><a href="products.html">Music DVDs</a></li>
						<li><a href="products.html">Hollywood Movies</a></li>
						<li><a href="products.html">New Releases</a></li>
						<li><a href="products.html">Best Programs</a></li>
						<li><a href="products.html">Album Songs</a></li>
						<li><a href="products.html">Pop</a></li>
						<li><a href="products.html">Country Music</a></li>
						<li><a href="products.html">Journals</a></li>
					</ul>
				</div>
				<div class="related-row">
